...
function Banner() {
    ...
    const [currentImage, setCurrentImage] = useState("./works/fitter/chlopek.png");
    const [currentBarbell, setCurrentBarbell] = useState("./works/fitter/barbell.png");
    ...
    useEffect(() => {
        ...
        const handleResize = () => {
            if (window.innerWidth <= 640) {
                ...
                setCurrentBarbell("./works/fitter/barbell.png");
    ...
    return (
        <div className={`relative h-auto border-2 border-gray-200 ${isSmallScreen && ''}`}>
            ...
            <motion.div
                className={` flex justify-center items-center md:mt-0 md:absolute ${isSmallScreen ? 'top-[80vh] right-[60vw] ' : 'top-[20vh]'} right-[30vw]`}>
            ...
            <div
                className={`absolute top-[20vh] sm:top-[25vh] md:top-[30vh] lg:top-[40vh] xl:top-[50vh] right-[10vw] ${isSmallScreen ? 'top-[30vh] ' : 'top-[10vh]'}`}>
