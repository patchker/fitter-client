...
function Content() {
    ...
    return (
        <div
            className="flex flex-col justify-center items-center m-auto border-2 bg-gradient-to-r from-slate-100 to-slate-50 border-gray-100 p-10 space-y-8 shadow-2xl">
            <div className="bg-white p-10 rounded-[50px] shadow-xl space-y-6">
                ...
                <p className="text-md text-gray-600 text-center">Śledź swoje postępy i osiągaj cele zdrowotne z naszymi
                    spersonalizowanymi planami.</p>
